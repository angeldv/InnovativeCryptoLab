// src/main.js
/**
 * Main entry point for InnovativeCryptoLab application
 */
...
class InnovativeCryptoLab {
    /**
     * Create a new InnovativeCryptoLab instance
...
module.exports = InnovativeCryptoLab;
...
if (require.main === module) {
    ...
    const app = new InnovativeCryptoLab({
        input: args.input,
        output: args.output,
